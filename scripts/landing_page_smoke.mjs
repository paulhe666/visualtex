...
const checks = [
  ...
  [landing.includes('const VERSION = "1.2.3"'), "The current desktop version is not configured"],
  ...
  [styles.includes(".landing-ocr-model-grid"), "The OCR model card layout is missing"],
