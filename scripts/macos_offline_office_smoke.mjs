...
expectIncludes(wordAdapter, "prefixRange.InsertAfter vbTab", "Numbered Word formulas must insert the center-tab prefix without expanding a collapsed Range backwards");
...
expectIncludes(wordAdapter, "VTResetNativeEquationNumberFormatting _", "Numbered OMML edits and conversions must refresh number height alignment");
